/* sdsl-cst_sada - prefix free parsing data structures
...
*/
/*!
   \file sdsl_cst_sada.cpp
   \brief sdsl_cst_sada.cpp build a sdsl sada CST.
...
int main(int argc, char *const argv[])
{
    ...
    if(args.store){
        ...
        std::string outfile = args.filename + ".sdsl.sada.cst";
